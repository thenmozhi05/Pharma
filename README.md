...
<body>
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(87, 255, 87);">
    <a class="navbar-brand" href="#">Thenu Pharmacy</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>

    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color: rgb(87, 255, 87)5;">
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>Welcome to Thenu Pharmacy</h1>
        <h3>Thenmozhi(212223100059)</h3>
        <p>Welcome to Thenu Pharmacy, your trusted source for high-quality pharmaceutical products. We are dedicated to improving the health and well-being of our customers by providing safe and effective medications.</p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>About Thenu Pharmacy</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
  <!-- Custom CSS -->
  <style>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(87, 255, 87);">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color: rgb(87, 255, 87);">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="product 1.jpeg" class="card-img-top" alt="Product 1">
            <div class="card-body">
              <h5 class="card-title">Product 1</h5>
              <p class="card-text">Everherb Karela Jamun Juice - Helps Maintains Healthy Sugar Levels -Helps In Weight Management - 1l.</p>
              <a href="#" class="btn" style="background-color: rgb(87, 255, 87);">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="product 2.jpg" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="product 3.jpg" class="card-img-top" alt="Product 3">
            <div class="card-body">
          ...
          <div class="card">
            <img src="product 4.jpg" class="card-img-top" alt="Product 3">
            <div class="card-body">
              <h5 class="card-title">Product 4</h5>
              <p class="card-text">Himalaya Septilin Syrup 200ml is a natural herbal formulation that helps boost immunity and supports the body's defense mechanisms.</p>
              <a href="#" class="btn" style="background-color: rgb(87, 255, 87);">Buy Now</a>
            </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <form>
          ...
          <button type="submit" class="btn" style="background-color: rgb(87, 255, 87);">Submit</button>
        </form>
      </div>
      <div class="col-md-4">
        <h2>Thenu Pharmacy</h2>
        <address>
